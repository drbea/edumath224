...
from .info import EMAIL_USE_TLS, EMAIL_HOST_PASSWORD, EMAIL_HOST_USER, EMAIL_HOST, EMAIL_PORT
...
SECRET_KEY = 'django-insecure-*pqbaa*l5hw&!(8!nyw2dgt6&72ry=r&q&4hiynmnqjpdokgek'
